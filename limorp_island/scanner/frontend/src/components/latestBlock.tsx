        ...
        {blocks.map((block) => (
          ...
          >
            ...
            <div className="hidden md:block">
              <p className="text-xs font-medium max-w-37.5 truncate">
                Miner:{" "}
                <a
                  ...
                  {(() => {
                    ...
                    const txAmounts =
                      block.transactions?.reduce(
                        (sum: any, tx: any) => sum + BigInt(tx.amount),
                        0n,
                      ) || 0n;
                    const total = blockReward + txAmounts;
                    return formatLMR(total.toString(), 2);
                  })()}{" "}
                  LMR
                </p>
              </div>
